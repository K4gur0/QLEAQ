 ...
 */
final class Version20200306201708 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE nomade (id INT AUTO_INCREMENT NOT NULL, nom_photo VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, cp INT DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, budget DOUBLE PRECISION DEFAULT NULL, presentation LONGTEXT DEFAULT NULL, statut VARCHAR(255) DEFAULT NULL, date_creation_compte DATETIME NOT NULL, sexe VARCHAR(255) DEFAULT NULL, is_confirmed TINYINT(1) NOT NULL, security_token VARCHAR(255) NOT NULL, type_sejour VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_244E9AA8E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
